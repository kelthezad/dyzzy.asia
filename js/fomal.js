...
function createtime1() {
  var grt = new Date("09/12/2023 00:00:00"); //此处修改你的建站时间或者网站上线时间
  now1.setTime(now1.getTime() + 250);
  var days = (now1 - grt) / 1000 / 60 / 60 / 24;
  var dnum = Math.floor(days);

  var ascll = [
    `欢迎来到Kelthezad's blog!`,
    `Future is now 🍭🍭🍭`,
    `
...
function createtime() {
  ...
  var start = new Date("09/05/1977 00:00:00"); // 旅行者1号开始计算的时间
  var dis = Math.trunc(23400000000 + ((now - start) / 1000) * 17); // 距离=秒数*速度 记住转换毫秒
  var unit = (dis / 149600000).toFixed(6);  // 天文单位
  // 网站诞生时间
  var grt = new Date("12/02/2023 00:00:00");
  ...
  (currentTimeHtml =
    hnum < 18 && hnum >= 9
      ? `<img class='boardsign' src='https://img.dyzzy.asia/svg/下雪.svg' title='鬼天气真的冷！'><br> <div style="font-size:12px;font-weight:bold">本站居然运行了 ${dnum} 天 ${hnum} 小时 ${mnum} 分 ${snum} 秒 <i id="heartbeat" class='fas fa-heartbeat'></i> <br> 旅行者 1 号当前距离地球 ${dis} 千米，约为 ${unit} 个天文单位 🚀</div>`
      : `<img class='boardsign' src='https://img.dyzzy.asia/svg/下雪.svg' title='鬼天气真的冷！'><br> <div style="font-size:12px;font-weight:bold">本站居然运行了 ${dnum} 天 ${hnum} 小时 ${mnum} 分 ${snum} 秒 <i id="heartbeat" class='fas fa-heartbeat'></i> <br> 旅行者 1 号当前距离地球 ${dis} 千米，约为 ${unit} 个天文单位 🚀</div>`),
...
if (localStorage.getItem("blogbg") != undefined) {
  ...
  document.getElementById("defineBg").innerText = `:root{
    --default-bg: url(https://www.z4a.net/images/2023/10/21/178FC6DB4C226D0D11A664D940572E14.png);
    --darkmode-bg:url(https://www.z4a.net/images/2023/10/21/178FC6DB4C226D0D11A664D940572E14.png);
    --mobileday-bg: url(https://www.z4a.net/images/2023/10/21/178FC6DB4C226D0D11A664D940572E14.png);
    --mobilenight-bg: url(https://www.z4a.net/images/2023/10/21/178FC6DB4C226D0D11A664D940572E14.png);
  }`;
}
// 切换背景主函数
function changeBg(s) {
